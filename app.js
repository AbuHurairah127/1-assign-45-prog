...
const favoriteFruits = () => {
    let favorite_fruits = ["Banana", "Apple", "Mangoes", "Orange"];
    ...
    for (let i = 0; i < usernames.length; i++) {
        if (usernames[i] === currentUser) {
            ...
            if (currentUser === "admin") {
                console.log("Assalam u Alaikum Admin! Would you like to see status report.");
                break;
            }
            console.log(`Assalam u Alaikum ${usernames[i]}! Thank you for logging in again.`);
            break;
        }
    }
};
...
const checkingUserNames = () => {
    let isUserNameNotAvailable = false;
    let current_users = [
        "abuhurairah127",
        "hassansaeed123",
        "ahmadJajja786",
 ...
 * It takes no arguments and returns nothing.
 */
const pizzaStatements = () => {
    let pizza_flavours = ["Fajita", "Malai Boti", "Chicken Tikka"];
 ...
 */
const sandwiches = () => {
    const sandwichItems = (sandwichToppings) => {
        console.log(`I want to have these toppings on my sandwich ${sandwichToppings}`);
    };
    let sandwichToppings1 = [
        "Tomato Sauce",
        "White Sauce",
        "Mayonnaise",
    ];
    let sandwichToppings2 = ["White Sauce", "Mayonnaise"];
    let sandwichToppings3 = [
        "Tomato Sauce",
        "White Sauce",
        "Mayonnaise",
        "Chilli Sauce",
...
const cars = () => {
    const carDetails = (manufacturer, carModel, color, seats) => {
        let carDetails = {
            manufacturer: manufacturer,
            carModel: carModel,
        };
        if (color !== "") {
            carDetails = Object.assign(Object.assign({}, carDetails), { color: color });
        }
        if (seats !== "") {
            carDetails = Object.assign(Object.assign({}, carDetails), { seats: seats });
        }
        return carDetails;
    };
